...
var client = (0, urql_1.createClient)({
    ...
    exchanges: [
        ...
        (0, exchange_auth_1.authExchange)({
            ...
            addAuthToOperation: function (_a) {
                var authState = _a.authState, operation = _a.operation;
                if (!authState || !authState.token) {
                    return operation;
                }
                var fetchOptions = typeof operation.context.fetchOptions === "function"
                    ? operation.context.fetchOptions()
                    : operation.context.fetchOptions || {};
                return (0, urql_1.makeOperation)(operation.kind, operation, __assign(__assign({}, operation.context), { fetchOptions: __assign(__assign({}, fetchOptions), { headers: __assign(__assign({}, fetchOptions.headers), { Authorization: "Bearer ".concat(authState.token) }) }) }));
            },
